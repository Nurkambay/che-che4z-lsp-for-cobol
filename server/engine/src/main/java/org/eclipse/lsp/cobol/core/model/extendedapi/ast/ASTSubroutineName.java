...
/** Data transport object of AST for Subroutine Name node. */
@Value
@EqualsAndHashCode(callSuper = true)
public class ASTSubroutineName extends ASTNode {
  String name;
  List<Location> definitions;
  List<Location> usages;

  public ASTSubroutineName(
      Location location, String name, List<Location> definition, List<Location> usages) {
    super("SUBROUTINE_NAME", location);
    this.name = name;
