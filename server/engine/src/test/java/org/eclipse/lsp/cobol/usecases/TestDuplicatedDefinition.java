...
public class TestDuplicatedDefinition {
  ...
  private static final String TEXT_AMBIGUOUS_PARAGRAPH = "       IDENTIFICATION DIVISION.\n"
      + "       PROGRAM-ID.    CBACT01C.\n"
      + "       PROCEDURE DIVISION.\n"
      + "           PERFORM {#PARAG1|1}.\n"
      + "       {#*PARAG1}.\n"
  ...
  private static final String TEXT_PARAGRAPH = "       IDENTIFICATION DIVISION.\n"
      + "       PROGRAM-ID.    CBACT01C.\n"
      + "       PROCEDURE DIVISION.\n"
  ...
  @Test
  void testParagraph() {
    UseCaseEngine.runTest(TEXT_PARAGRAPH, ImmutableList.of(), ImmutableMap.of());
  }
